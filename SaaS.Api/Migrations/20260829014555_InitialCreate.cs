        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaxReportsPerMonth = table.Column<int>(type: "int", nullable: false),
                    MaxAiTokensPerMonth = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AiUsageLogs_EstimatedCost_NonNegative", "EstimatedCost >= 0");
                    table.ForeignKey(
                        name: "FK_AiUsageLogs_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportJobs_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiUsageLogs_ReportId_CreatedAt",
                table: "AiUsageLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportJobs_ReportId_Status",
                table: "ReportJobs",
